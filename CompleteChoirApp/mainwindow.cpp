    ...
    , ui(new Ui::MainWindow)
{
    ...
    btn_exit->setStyleSheet("background-color: red;border: 0px; color: white; font-size: 15px;font-family: Comic Sans MS;font: bold; padding-top: 3px;"
    ...
    ui->statusBar->insertWidget(3, btn_exit);
    ...
    connect(btn_exit, &QPushButton::clicked, this, &MainWindow::exit_clicked);
...
void MainWindow::exit_clicked()
{
    ...
    reply = QMessageBox::question(0, "Exit", "Are you sure you want to exit?", QMessageBox::Yes|QMessageBox::No);
